      ...
      <div className="container">
        ...
        <div className="welcome-text">
          <div className="texts">
            ...
            <p>
              O SecurityMob é um aplicativo no qual você pode ver os locais mais
              seguros, mais moviementados e com mais iluminação de onde você
              mora! E junto disso, você também pode fazer relatos para ajudar o
              banco de dados a deixar os filtros cada vez mais assertivos!
            </p>
          </div>
        </div>

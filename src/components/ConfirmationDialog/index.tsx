...
function ConfirmationDialog({handleFunction, icon, title, description}: Props) {
  return (
    <Dialog
    hideBackdrop={true}
    PaperProps={{
  ...
  >
    ...
    <DialogActions sx={{display:'flex', justifyContent:'center'}}>
      <Button variant='contained' className='button' onClick={handleFunction}>Continuar</Button>
    </DialogActions>
  </Dialog>
  )
}
